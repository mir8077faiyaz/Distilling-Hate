...
def train_and_eval(name, model_name):
    ...
    for ep in range(EPOCHS):
        ...
        # if dev_macro_f > best_dev_macro:
        #     best_dev_macro = dev_macro_f
        ...
        print(f"Epoch {ep+1}/{EPOCHS} | Loss={total_loss/len(train_loader):.4f} "
            f"| Dev Acc={dev_acc:.4f} | Dev MacroF1={dev_macro_f:.4f} "
            f"| Dev WeightedF1={dev_weighted_f:.4f} | Dev Score={dev_score:.4f}")
...
models = [
    ...
    # ("BanglaBERT Large", "csebuetnlp/banglabert"),
    # ("BanglaBERT Small", "csebuetnlp/banglabert_small"),
    # ("DistilBERT", "distilbert-base-multilingual-cased"),
    # ("mBERT", "bert-base-multilingual-cased"),
    # ("XLM-R Base", "xlm-roberta-base"),
    ("BanglaBERT Main LArge", "csebuetnlp/banglabert_large")
]
