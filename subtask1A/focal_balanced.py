...
class ClassBalancedLoss(nn.Module):
    def __init__(self, class_counts, beta=0.999, use_focal=True, gamma=2):
        super().__init__()
...
def train_teacher():
    ...
    beta=0.999,          # can tune later if you want
    use_focal=True,
    gamma=2)
...
def objective(trial):
    params = {
        ...
        "cb_beta": trial.suggest_float("cb_beta", 0.95, 0.9999),
